...
- Edição, pesquisa, metadados e explicabilidade ainda não foram implementados.
...
- Não há compactação, orçamento de tokens, edição, pesquisa ou metadados para as memórias persistidas.
